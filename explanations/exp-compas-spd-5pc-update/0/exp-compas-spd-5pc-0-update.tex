...
\begin{document}
    \begin{tikzpicture}[scale=1, every node/.style={scale=0.75}]
        \node (1) [fill=red!20,draw, rounded rectangle, line width=0.4mm] {Age $\in [25, 45]$};
        ...
        \node (5) [fill=white!20, draw, right=of 4, xshift=-12.5mm, rounded rectangle] {Juvenile felonies $=0$};
    \end{tikzpicture}
