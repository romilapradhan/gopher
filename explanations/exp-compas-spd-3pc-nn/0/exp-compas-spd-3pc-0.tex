...
\begin{document}
    \begin{tikzpicture}[scale=1, every node/.style={scale=0.75}]
        \node (1) [fill=red!20,draw, rounded rectangle] {Race $=$ Caucasian};
        ...
        \node (5) [fill=gray!20, draw, right=of 4, xshift=-12.5mm, rounded rectangle] {Juvenile other crimes $=0$};
        \node (6) [right=of 5, xshift=-12.5mm] {$\wedge$};
		\node (7) [fill=white, draw, right=of 6, xshift=-12.5mm, rounded rectangle] {Priors $=0$};
    \end{tikzpicture}
