...
\begin{document}
	...
	\node (3) [fill=yellow!20, draw, right=of 2, xshift=-12.5mm, rounded rectangle] {Relationship $=$ Spouse};
	\node (4) [right=of 3, xshift=-12.5mm] {$\wedge$};
	\node (5) [fill=white!20, draw, right=of 4, xshift=-12.5mm, rounded rectangle, line width=0.4mm] {Education $=$ Prof-school};
	\node (6) [right=of 5, xshift=-12.5mm] {$\wedge$};
	\node (7) [fill=white!20, draw, right=of 6, xshift=-12.5mm, rounded rectangle, line width=0.4mm] {Age $\geq45$};
	\end{tikzpicture}
