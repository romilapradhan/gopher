...
\begin{document}
    \begin{tikzpicture}[scale=1, every node/.style={scale=0.75}]
        \node (1) [fill=red!20,draw, rounded rectangle] {Credit history $=$ Existing paid back duly};
        \node (2) [right=of 1, xshift=-12.5mm] {$\wedge$};
        \node (3) [fill=white!20, draw, right=of 2, xshift=-12.5mm, rounded rectangle] {Credit amount $\le 2000$};
        \node (4) [right=of 3, xshift=-12.5mm] {$\wedge$};
        \node (5) [fill=white!20, draw, right=of 4, xshift=-12.5mm, rounded rectangle] {Gender $=$ Female};
        \node (6) [right=of 5, xshift=-12.5mm] {$\wedge$};
        \node (7) [fill=white, draw, right=of 6, xshift=-12.5mm, rounded rectangle] {Housing$=$ Own};
    \end{tikzpicture}
