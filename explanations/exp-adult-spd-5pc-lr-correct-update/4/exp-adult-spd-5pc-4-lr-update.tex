...
\begin{document}
    \begin{tikzpicture}[scale=1, every node/.style={scale=0.75}]
        \node (1) [fill=red!20,draw, rounded rectangle] {Gender $=$ Male};
        ...
        \node (5) [fill=white!20, draw, right=of 4, xshift=-12.5mm, rounded rectangle, line width=0.4mm] {Education $=$ Bachelors};
        \node (6) [right=of 5, xshift=-12.5mm] {$\wedge$};
        \node (7) [fill=white!20, draw, right=of 6, xshift=-12.5mm, rounded rectangle] {Race $=$ White};
    \end{tikzpicture}
