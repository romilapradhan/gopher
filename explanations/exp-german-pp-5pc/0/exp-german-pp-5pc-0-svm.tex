...
\begin{document}
    \begin{tikzpicture}[scale=1, every node/.style={scale=0.75}]
        \node (1) [fill=teal!20,draw, rounded rectangle] {Purpose $=$ Car (new)};
        ...
        \node (5) [fill=white!20, draw, right=of 4, xshift=-12.5mm, rounded rectangle] {Credit amount $<2,000$ DM};
        \node (6) [right=of 5, xshift=-12.5mm] {$\wedge$};
        \node (7) [fill=white, draw, right=of 6, xshift=-12.5mm, rounded rectangle] {Install plans $=$ None};
    \end{tikzpicture}
