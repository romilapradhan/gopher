...
\begin{document}
    \begin{tikzpicture}[scale=1, every node/.style={scale=0.75}]
        ...
        \node (3) [fill=yellow!20, draw, right=of 2, xshift=-12.5mm, rounded rectangle] {Savings $< 100$};
        \node (4) [right=of 3, xshift=-12.5mm] {$\wedge$};
        \node (5) [fill=lightgray, draw, right=of 4, xshift=-12.5mm, rounded rectangle] {Telephone $=$ Yes};
        \node (6) [right=of 5, xshift=-12.5mm] {$\wedge$};
        \node (7) [fill=white, draw, right=of 6, xshift=-12.5mm, rounded rectangle] {Job $=$ Skilled};
    \end{tikzpicture}
