...
\begin{document}
	...
	\node (1) [fill=blue!20,draw, rounded rectangle] {Sex $=$ Male};
	\node (2) [right=of 1, xshift=-12.5mm] {$\wedge$};
	\node (3) [fill=teal!20, draw, right=of 2, xshift=-12.5mm, rounded rectangle] {Score text $=$ Medium};
	\node (4) [right=of 3, xshift=-12.5mm] {$\wedge$};
	\node (5) [fill=green!20, draw, right=of 4, xshift=-12.5mm, rounded rectangle] {Age $\geq 45$};
	\node (6) [right=of 5, xshift=-12.5mm] {$\wedge$};
	\node (7) [fill=gray!20, draw, right=of 6, xshift=-12.5mm, rounded rectangle] {Juvenile other crimes  $=0$};
	\end{tikzpicture}
