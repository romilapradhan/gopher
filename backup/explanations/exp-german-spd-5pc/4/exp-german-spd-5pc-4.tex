...
\begin{document}
    \begin{tikzpicture}[scale=1, every node/.style={scale=0.75}]
        \node (1) [fill=blue!20,draw, rounded rectangle] {Age$\ge 45$};
        ...
        \node (5) [fill=teal!20, draw, right=of 4, xshift=-12.5mm, rounded rectangle] {Foreign worker $=$ Yes};
        \node (6) [right=of 5, xshift=-12.5mm] {$\wedge$};
        \node (7) [fill=lightgray, draw, right=of 6, xshift=-12.5mm, rounded rectangle] {Telephone $=$ Yes};
    \end{tikzpicture}
