...
\begin{document}
    \begin{tikzpicture}[scale=1, every node/.style={scale=0.75}]
        ...
        \node (3) [fill=blue!20, draw, right=of 2, xshift=-12.5mm, rounded rectangle] {Liabilities $=1$};
        ...
        \node (7) [fill=white, draw, right=of 6, xshift=-12.5mm, rounded rectangle] {Status$<0$ DM};
    \end{tikzpicture}
