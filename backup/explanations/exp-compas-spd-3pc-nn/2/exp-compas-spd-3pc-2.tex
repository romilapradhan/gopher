...
\begin{document}
	...
	\node (3) [fill=blue!20, draw, right=of 2, xshift=-12.5mm, rounded rectangle] {Sex $=$ Male};
	...
	\node (7) [fill=white!20, draw, right=of 6, xshift=-12.5mm, rounded rectangle] {Juvenile felonies $=0$};
	\end{tikzpicture}	
\end{document}